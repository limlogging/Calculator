...
print(calculator.mul(5, 6))
print(calculator.div(10, 2))
print(calculator.remainder(5, 3))
*/
/*
 Lv3
...
print(addOperation.cal(10, 20))
let substractOperation = SubstractOperation()
print(substractOperation.cal(10, 20))
let multiplyOperation = MultiplyOperation()
print(multiplyOperation.cal(10, 20))
let divideOperation = DivideOperation()
print(divideOperation.cal(10, 20))
let remainerOper = RemainderOperation()
print(remainerOper.cal(10, 20))
